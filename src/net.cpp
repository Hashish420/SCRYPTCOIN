...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "scrypt " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"52.207.247.50", "52.207.247.50"},
    {"54.152.47.236", "54.152.47.236"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. scrypt is probably already running."), addrBind.ToString().c_str());
        else
