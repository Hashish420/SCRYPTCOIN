...
#if defined(NDEBUG)
# error "scrypt cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x5c8cf281dfff7984934e14d17014cccb468640036d0a208e4518a7a8d1cda5be");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // scrypt: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "scrypt Signed Message:\n";
...
{
    // scrypt: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    int64 nSubsidy = 47 * COIN;
            ...
            if(nHeight == 1)
            {
            nSubsidy = 7861818 * COIN;
            }

    // Subsidy is cut in half every 280000 blocks
    nSubsidy >>= (nHeight / 280000);

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1111 * 60;
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // scrypt: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // scrypt: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1466609105, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "2016 06 22 yellowstone n activity";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 47 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04a71ef84abe8638efb803d5d6789897b8454f554316c75f4f669ad7016d7e783b47a13baf3b0f0b09f2e161d7f68b07e37f60aeaf9e805a9bd9bb9c801176a5cc") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1466609105;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1136704;
        ...
        assert(block.hashMerkleRoot == uint256("0x8c71b095e32fdd65addcbedec8e6516562c2b165b2d017724c432fe76e14a8c5"));
...
unsigned char pchMessageStart[4] = { 0xa2, 0x4e, 0xa9, 0x4e }; // scrypt: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("scryptMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("scryptMiner : ProcessBlock, block not accepted");
    }
